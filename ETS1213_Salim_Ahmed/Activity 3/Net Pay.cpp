...
int main()
{
    f gross_salary,basic_salary,bonus,net_salary,worked_hours,bonus_per_hour;
    f pension,tax,bonus_payment;
    f pension_rate=0.07,tax_rate;
   cout<<"Enter your basic salary in ETB"<<endl;
   cin>>basic_salary;
